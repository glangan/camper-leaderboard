...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        'td',
	        null,
	        React.createElement('img', { src: this.props.obj.img }),
	        React.createElement(
	          'a',
	          { href: "https://www.freecodecamp.com/" + this.props.obj.username, target: '_blank' },
	      ...
	      React.createElement(
	        'td',
	        null,
	        this.props.obj.recent
	      ),
	      React.createElement(
	        'td',
	        null,
	        this.props.obj.alltime
	      )
	    );
	  }
	});
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      this.state.content.map(function (object, i) {
	        return React.createElement(TableRow, { obj: object, value: i, key: i });
	      })
	    );
	  }
	});
	...
	var Table = React.createClass({
	  ...
	  changeToRecent: function changeToRecent() {
	  ...
	  changeToAlltime: function changeToAlltime() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            'th',
	            { onClick: this.changeToRecent, className: this.state.recentClass },
	            'Points in past 30 days'
	          ),
	          React.createElement(
	            'th',
	            { onClick: this.changeToAlltime, className: this.state.alltimeClass },
	            'All time points'
	          )
	        )
	      ),
	      React.createElement(MainTable, { display: this.state.display })
	    );
	  }
	});
